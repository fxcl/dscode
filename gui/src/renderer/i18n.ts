...
const en = {
  ...
  'chat.welcome.body': 'Select a project folder and click "New Chat" to start coding with DSCode.',
  ...
  'composer.disclaimer': 'DSCode can make mistakes. Review important code before running it.',
  ...
  'composer.permissionPlan': 'DSCode: applies immediately; other runtimes: new chat',
  'usage.tokens': 'tokens',
  'usage.cache': 'cache',
  'usage.context': 'ctx',
  ...
  'settings.modelNote': 'Keys are stored in ~/.dscode/auth.json (readable only by you). Model settings apply to new chats.',
  ...
  'settings.permissions.plan': 'Plan',
  'settings.permissions.auto': 'Auto',
  ...
  'settings.permissionsNote.plan': 'DSCode native: read-only until you approve a plan, then asks per action. Other runtimes behave as read-only. Applies to new chats.',
  'settings.permissionsNote.auto': 'DSCode native default: safe actions run automatically, sandbox/network escalation still asks. Other runtimes behave as full access. Applies to new chats.',
  ...
  'settings.on': 'On',
  'settings.off': 'Off',
  'settings.harness': 'Tool harness',
  'settings.harnessMinimal': 'Minimal',
  'settings.harnessSafe': 'Safe',
  'settings.sandbox': 'Sandbox',
  'settings.sandboxReadOnly': 'Read-only',
  'settings.sandboxWorkspaceWrite': 'Workspace write',
  'settings.sandboxDanger': 'Full access',
  'settings.webSearch': 'Server-side web search',
  'settings.transport': 'API transport',
  'settings.transportResponses': 'Responses',
  'settings.transportChat': 'Chat',
  'settings.baseUrl': 'API base URL',
  'settings.dscodeRuntimeNote':
    'DSCode runtime options — applied to new sessions of the dscode CLI.',
  ...
  'settings.authNote': 'Credentials live in DSCode itself; the GUI only displays what the runtime reports.',
  ...
  'settings.authEmpty': 'No providers reported by DSCode.',
  'settings.authUnsupported': 'This DSCode version does not report providers.',
  'settings.authRuntimeDown': 'DSCode is not running — start a chat or install it first.',
  ...
  'settings.authSignOutConfirm': 'Sign out {name}? The credential is removed from DSCode.',
  'settings.authEnvNote': 'Also set as an environment variable — DSCode may stay connected after sign-out.',
  ...
  'settings.thinkingAutoNote': 'Let DSCode choose the reasoning effort automatically.',
  'settings.runtimeLoading': 'Loading DSCode configuration…',
  'settings.runtimeError': "Couldn't load runtime settings.",
  'settings.runtimeRetry': 'Retry',
  'settings.machineSkillsUnsupported': 'Not supported by this DSCode version',
  ...
  'settings.machineSkillsUnsupportedDescription':
    'This DSCode version does not expose Machine Skills configuration.',
  ...
  'plugins.communityPlaceholder': 'Search npm for agent packages…',
  'plugins.searching': 'Searching…',
  'plugins.noResults': 'No packages found.',
  'plugins.buildOwn': 'No suitable plugin? Build your own',
  'plugins.buildOwnHint': 'Starts a chat where the agent scaffolds an extension or skill for you.',
  'plugins.buildOwnPrompt':
    'I want to build a new package (an extension or a skill). First ask me what problem it should solve and which commands or tools it needs. Then scaffold the package in the current project (manifest plus a working example), and tell me how to install it from the DSCode GUI Plugins page. My idea: ',
  ...
  'setup.ready.title': 'DSCode is ready',
  'setup.ready.subtitle': 'Launching main interface…',
  'setup.welcome.title': 'Welcome to DSCode GUI',
  'setup.welcome.subtitle': 'A Codex-style desktop interface for DSCode',
  'setup.missing': 'DSCode (omp) was not found on this Mac. DSCode GUI needs it to run the AI coding agent.',
  'setup.autoInstall': 'Auto-install DSCode',
...
const zh: Record<I18nKey, string> = {
  ...
  'chat.welcome.body': '选择项目文件夹，然后点击"新建对话"，让 DSCode 帮你写代码。',
  ...
  'composer.disclaimer': 'DSCode 可能会犯错，重要代码运行前请人工检查。',
  ...
  'composer.permissionPlan': 'DSCode 立即生效；其他运行时新会话生效',
  'usage.tokens': 'tokens',
  'usage.cache': '缓存',
  'usage.context': '上下文',
  ...
  'settings.modelNote': '密钥保存在 ~/.dscode/auth.json（仅本人可读）。模型设置对新对话生效。',
  ...
  'settings.permissions.plan': '计划',
  'settings.permissions.auto': '自动',
  ...
  'settings.permissionsNote.plan': 'DSCode 原生模式：计划批准前只读，批准后逐条询问；其他运行时等同只读。对新对话生效。',
  'settings.permissionsNote.auto': 'DSCode 原生默认：安全操作自动执行，沙箱/网络升级仍会询问；其他运行时等同完全访问。对新对话生效。',
  ...
  'settings.on': '开',
  'settings.off': '关',
  'settings.harness': '工具集',
  'settings.harnessMinimal': '精简',
  'settings.harnessSafe': '安全',
  'settings.sandbox': '沙箱',
  'settings.sandboxReadOnly': '只读',
  'settings.sandboxWorkspaceWrite': '工作区可写',
  'settings.sandboxDanger': '完全访问',
  'settings.webSearch': '服务端联网搜索',
  'settings.transport': 'API 传输协议',
  'settings.transportResponses': 'Responses',
  'settings.transportChat': 'Chat',
  'settings.baseUrl': 'API 地址',
  'settings.dscodeRuntimeNote': 'DSCode 运行时选项 — 对 dscode CLI 的新会话生效。',
  ...
  // Authentication (runtime-native)
  'settings.auth': '认证',
  'settings.authNote': '凭证由 DSCode 自己保存；界面只显示运行时报告的真实状态。',
  ...
  'settings.authEmpty': 'DSCode 没有报告任何 Provider。',
  'settings.authUnsupported': '此 DSCode 版本不支持 Provider 查询。',
  'settings.authRuntimeDown': 'DSCode 未在运行 — 先开始一个对话或完成安装。',
  ...
  'settings.authSignOutConfirm': '退出 {name}？凭证将从 DSCode 中移除。',
  'settings.authEnvNote': '此 Provider 同时设置了环境变量 — 退出登录后 DSCode 可能仍保持连接。',
  ...
  'settings.thinkingAutoNote': '让 DSCode 自动选择推理深度。',
  'settings.runtimeLoading': '正在加载 DSCode 配置…',
  'settings.runtimeError': '无法加载运行时设置。',
  'settings.runtimeRetry': '重试',
  'settings.machineSkillsUnsupported': '此 DSCode 版本不支持',
  'settings.machineSkillsUnknown': '无法确定',
  'settings.machineSkillsRefresh': '刷新',
  'settings.machineSkillsUnsupportedDescription': '此 DSCode 版本不支持本机技能配置。',
  ...
  'plugins.communityPlaceholder': '搜索 npm 上的插件包…',
  'plugins.searching': '搜索中…',
  'plugins.noResults': '没有找到相关插件。',
  'plugins.buildOwn': '没有合适的插件？自己做一个',
  'plugins.buildOwnHint': '开启一个对话，让 agent 为你在当前项目里搭好插件骨架。',
  'plugins.buildOwnPrompt':
    '我想做一个新的插件（extension 或 skill）。请先问我：它要解决什么问题、需要哪些命令或工具；然后在当前项目里搭好插件骨架（含清单与可运行示例），并告诉我怎么在 DSCode GUI 的插件页把它装上。我的想法是：',
  ...
  'setup.ready.title': 'DSCode 已就绪',
  'setup.ready.subtitle': '正在进入主界面…',
  'setup.welcome.title': '欢迎使用 DSCode GUI',
  'setup.welcome.subtitle': 'DSCode 的 Codex 风格桌面界面',
  'setup.missing': '在这台 Mac 上未找到 DSCode（omp）。DSCode GUI 需要它来运行 AI 编程助手。',
  'setup.autoInstall': '自动安装 DSCode',
