...
/** Returns the path to the models.json file used by DSCode's model runtime. */
export function getModelsJsonPath(agentDir = getDSCodeAgentDir()): string {
  return `${agentDir}/models.json`;
}
